...
const pretestStudentDb = async (school,index,score) => {
 try{
     console.log(score);
...
//console.log(intervaljson[0].lft);
  ...
  // console.log(testScore);
   ...
   console.log(defaultScore);
    ...
    studentarr.push({id : defaultScore[i].student_id, name : studentjson[0].name, score : defaultScore[i].pre_test_score });
    }
