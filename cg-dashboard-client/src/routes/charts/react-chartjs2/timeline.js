            ...
            xaxis: [
              {
                ...
                label: {
                  ...
                  text: ''+((this.props.series[0].data[0].y[1] + this.props.series[0].data[0].y[0])/2).toFixed(2)
                }
              },
              {
              ...
              label: {
                ...
                text: ''+((this.props.series[1].data[0].y[1] + this.props.series[1].data[0].y[0])/2).toFixed(2)
              }
            },
            {
              x : 0,
