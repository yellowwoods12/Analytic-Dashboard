...
import StackedBar from '../../charts/react-chartjs2/subjectCompletionWithGradeStackedBar';
...
import SimpleBarChartComponent from '../../../container/usageSubjectWise';
	...
	render() {
		...
		return (
            ...
            <RctCollapsibleCard>
             ...
             <RctCollapsibleCard>
			 <Typography>SUBJECT COMPLETION (GRADE-WISE)</Typography>
