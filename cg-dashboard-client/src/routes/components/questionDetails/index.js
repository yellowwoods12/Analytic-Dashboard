...
import  DataTable  from '../../tables/question-table';
	...
	render() {
		...
		return (
			...
			<div className= "row" style ={{flex:2}}>
             ...
             <div >
                 <RctCollapsibleCard>
			  <Typography variant="h5" component="h5" style={{marginBottom: 50}}>Q. {this.props.location.state.question}</Typography>
			  <DataTable width= "40%" school={this.props.location.state.school} data={this.props.location.state.details}/>
				</RctCollapsibleCard>
