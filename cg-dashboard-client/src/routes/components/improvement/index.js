...
import ApexChart from '../../charts/react-chartjs2/timeline';
...
export default class Cards extends Component {
   ...
   //}
	...
	onLearning(){
		console.log(this.props.location.state.series);
	...
	render() {
		return (
			...
			<div className= "row" style ={{flex:2}}>
			 ...
			 <RctCollapsibleCard>
				<CustomBar filter={this.props.location.state.defaultImprove} school={this.props.location.state.school} user={this.props.location.state.user}/>
			</RctCollapsibleCard>
             <div className="row">
            ...
            <RctCollapsibleCard>
                 <DataTable data = {this.props.location.state.defaultImprove[0][0].improvement}  />
