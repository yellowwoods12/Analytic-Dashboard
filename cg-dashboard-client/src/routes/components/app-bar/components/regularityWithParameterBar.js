...
import FromDatePickers from '../../../advance-ui-components/dateTime-picker/components/RegularityWithParameterDatePicker';
...
class CustomBar extends Component {
    ...
    lastMonth(){
      ...
      console.log(this.props.parameter_list);
      ...
      console.log(todate); 
      fetch('https://impact-api.convegenius.com/api/regularityWithParameterWithMonthFilter' , {
         mode :"cors",
         method: "POST",
         headers: {
           'Content-type': 'application/json'
         },
         body: JSON.stringify({from: fromdate, to: todate, school: this.props.school, state : this.props.parameter_list})
        })
    ...
    var daysinms = sunday.getTime() - monday.getTime();
     ...
     monday = yyyy + '-' + mm + '-' +dd ;
      ...
      fetch('https://impact-api.convegenius.com/api/regularityWithParameterWithWeekFilter' , {
         ...
         body: JSON.stringify({from: monday, to: sunday, school: this.props.school, state: this.props.parameter_list, days : days})
        })
        .then((result) => result.json())
        .then((regularity) => { 
           console.log("res");
    ...
    onRegularityClick(){
      ...
      console.log(this.props.regularity);
        //  if(info.success == "login sucessfull"){
           this.props.history.push({
            ...
            <div>
               ...
               <UncontrolledDropdown nav className="list-inline-item vr-super">
                  ...
                  <DropdownToggle nav >
                        ...
                        <FromDatePickers school={this.props.school} parameter_list ={this.props.parameter_list}/>
                        </DropdownToggle>
                  </UncontrolledDropdown>
