...
import SimpleBarChartComponent from '../../../container/usageGradeWise';

import StackedBar from '../../charts/react-chartjs2/usageGradeWiseStackedBar';
...
export default class Cards extends Component {
   ...
   //}
	...
	render() {
		console.log(this.props.location.state.usageStats);
		return (
