...
import  DataTable  from '../../tables/error-table';
	...
	render() {
		...
		return (
			...
			<div className= "row" style ={{flex:2}}>
             ...
             <div >
                 <RctCollapsibleCard>
			  <DataTable school={this.props.location.state.school} data={this.props.location.state.error} user={this.props.location.state.user}/>
				</RctCollapsibleCard>
			</div>
			</div>
		);
