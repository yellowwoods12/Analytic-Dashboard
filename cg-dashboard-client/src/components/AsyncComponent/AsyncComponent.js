...
//Learning Table
const AsyncLearningStudentsComponent = Loadable({
   loader: () => import("Routes/tables/learning-table"),
   loading: () => <RctPageLoader />,
});
...
//home buttons
const AsyncUIHomeComponent = Loadable({
   loader: () => import("Routes/components/card"),
   loading: () => <RctPageLoader />,
});

//health component
const AsyncHealth = Loadable({
   loader: () => import("Routes/components/health"),
   loading: () => <RctPageLoader />,
});

//school component
const AsyncSchool = Loadable({
   loader: () => import("Routes/components/school"),
   loading: () => <RctPageLoader/>
});

const Asyncsyncing = Loadable({
   loader: () => import("Routes/components/syncing"),
   loading: () => <RctPageLoader />,
});

const AsyncEnrollment = Loadable({
   loader: () => import("Routes/components/enrollment"),
   loading: () => <RctPageLoader />,
});

const AsyncUtilisation = Loadable({
   loader: () => import("Routes/components/utilisation"),
   loading: () => <RctPageLoader />,
});

const AsyncAchievement = Loadable({
   loader: () => import("Routes/components/achievement"),
   loading: () => <RctPageLoader />,
});

const AsyncLearning = Loadable({
   loader: () => import("Routes/components/learning"),
   loading: () => <RctPageLoader />,
});

const AsyncLearningStudents = Loadable({
   loader: () => import("Routes/components/learning-students"),
   loading: () => <RctPageLoader />,
});

const AsyncImprovement = Loadable({
   loader: () => import("Routes/components/improvement"),
   loading: () => <RctPageLoader />,
});

const AsyncRegularity = Loadable({
   loader: () => import("Routes/components/regularity"),
   loading: () => <RctPageLoader />,
});

const AsyncRegularityWithParameterInput = Loadable({
   loader: () => import("Routes/components/regularityWithParameterInput"),
   loading: () => <RctPageLoader />,
});

const AsyncRegularityWithParameter = Loadable({
   loader: () => import("Routes/components/regularityWithParameter"),
   loading: () => <RctPageLoader />,
});


const AsyncUsage = Loadable({
   loader: () => import("Routes/components/usage"),
   loading: () => <RctPageLoader />,
});

const AsyncUsageStatsGradeWise = Loadable({
   loader: () => import("Routes/components/usageStatsGradeWise"),
   loading: () => <RctPageLoader />,
});

const AsyncUsageFromRegularity = Loadable({
   loader: () => import("Routes/components/usageFromRegularity"),
   loading: () => <RctPageLoader />,
});

const AsyncUsageStatsGradeWiseFromRegularity = Loadable({
   loader: () => import("Routes/components/usageStatsGradeWiseFromRegularity"),
   loading: () => <RctPageLoader />,
});

const AsyncSubjectCompletionWithGradeFilter = Loadable({
   loader: () => import("Routes/components/subjectCompletionWithGradeFilter"),
   loading: () => <RctPageLoader />,
});

const AsyncChapterCompletionWithSubjectFilter = Loadable({
   loader: () => import("Routes/components/chapterCompletionWithSubjectFilter"),
   loading: () => <RctPageLoader />,
});

const AsyncChapterProgressWithChapterFilter = Loadable({
   loader: () => import("Routes/components/chapterProgressWithChapterFilter"),
   loading: () => <RctPageLoader />,
});

const AsyncChapterProgressStudentList = Loadable({
   loader: () => import("Routes/components/chapterProgressStudentList"),
   loading: () => <RctPageLoader />,
});


const AsyncCommonErrorReport = Loadable({
   loader: () => import("Routes/components/commonErrorReport"),
   loading: () => <RctPageLoader />,
});


const AsyncQuestionDetails = Loadable({
   loader: () => import("Routes/components/questionDetails"),
   loading: () => <RctPageLoader />,
});


const AsyncLearningOnProjectLevel = Loadable({
   loader: () => import("Routes/components/learningOnProjectLevel"),
   loading: () => <RctPageLoader />,
});

const AsyncImprovementOnProjectLevel = Loadable({
   loader: () => import("Routes/components/improvementOnProjectLevel"),
   loading: () => <RctPageLoader />,
});

const AsyncSyncingMax = Loadable({
   loader: () => import("Routes/components/syncingMax"),
   loading: () => <RctPageLoader />,
});
...
export {
   ...
   AsyncLearningStudentsComponent,
   AsyncImprovement,
   AsyncRegularity,
